...
public class MyJLabel {
	...
	public void setLabel(final JPanel pa[][], final JPanel button, String name) {
		...
		if (name.equals("BR") || name.equals("BKN") || name.equals("BB") || name.equals("BQ") || name.equals("BK")
				|| name.equals("BP")) {
			if (name.equals("BR")) {
		...
		} else if (name.equals("WR") || name.equals("WKN") || name.equals("WB") || name.equals("WQ")
				|| name.equals("WK") || name.equals("WP")) {
			if (name.equals("WR")) {
		...
		pawns.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (k == 0) {
					...
					System.out.println("click " + 1 + "  pawn position " + x + "," + y + " " + fisrtLabelText
							+ " color " + firstLabel.getBackground() + " state " + state);
				...
				if (k == 1) {
					...
					System.out.println("click " + 2 + "  pawn position " + x + "," + y + " " + fisrtLabelText
							+ " color " + secontLabel.getBackground() + " state " + state);
